...
public interface ReportMapper {
    ...
    // 3. 카테고리별 할일 등록 비율
    List<Map<String, Object>> findCategoryRegistrationRatio(@Param("userId") Long userId,
                                                            @Param("startDate") String startDate,
                                                            @Param("endDate") String endDate);

    // 4. 카테고리별 할일 완료 비율
    List<Map<String, Object>> findCategoryCompletionRatio(@Param("userId") Long userId,
                                                          @Param("startDate") String startDate,
                                                          @Param("endDate") String endDate);
